...
def Line_patrol_IR():
    ...
    while True:
        ...
        right_IR = m.pin1.read_digital()#Pin1 receives the analog value of the right infrared pair tube voltage (0-1023)
        left_IR = m.pin2.read_digital()#pin2 receives the analog value of the left infrared pair tube voltage (0-1023)
